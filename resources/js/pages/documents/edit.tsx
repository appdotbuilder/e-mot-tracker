...
export default function EditDocument({ document, statusOptions, departmentOptions }: Props) {
    const { data, setData, patch, processing, errors } = useForm({
        register_number: document.register_number,
        ...
        incoming_date: document.incoming_date,
    ...
    return (
        <AppShell>
            <Head title={`Edit Document - ${document.register_number}`} />
            ...
            <div className="p-6">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">✏️ Edit Document</h1>
                        <p className="text-gray-600 mt-1">Modify document: {document.register_number}</p>
                    </div>
                </div>
